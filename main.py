...
##
Label(root, text="Facebook Video Downloader", font='Helvetica 20 bold', bg="royalblue3", fg="white", relief="flat", pady=3).place(x=10, y=10)
Label(root, text="Enter url :", font='Helvetica 15 bold', bg='royalblue3', fg='white').place(x=20, y=120)
input_url = StringVar()
video_url = Entry(root, textvariable=input_url, width=40, font="Helvetica 15")
video_url.place(x=120, y=120)

Label(root, text="Choose Browse path", font='Helvetica 15 bold', bg='royalblue3', fg='white').place(x=20, y=165)
