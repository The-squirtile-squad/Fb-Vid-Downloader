...
def show():
    ...
    lab = Label(root, text=print_records, font="Helvetica 10", bg='royal blue3')
    lab.place(x=0, y=530)
    con.commit()
    con.close()
...
Label(root, text="Facebook Video Downloader", font='Helvetica 20', bg="royal blue3", fg="white", relief="flat", pady=3).place(x=10, y=10)
Label(root, text="Enter url :", font='Helvetica 15', bg='royal blue3', fg='white').place(x=20, y=120)
input_url = StringVar()
...
Label(root, text="Choose Browse path", font='Helvetica 15', bg='royal blue3', fg='white').place(x=20, y=165)
...
identity = Label(root, text='Delete ID', font='Helvetica 15', bg='royal blue3', fg='white')
...
# Download details
details = Label(root, font='Helvetica 12', relief='flat', bg='royal blue3', fg='white', padx=10, pady=5)
