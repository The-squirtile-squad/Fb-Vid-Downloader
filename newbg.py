...
def edit():
    ...
    label_1 = Label(editor, text="Update", bg="crimson", fg="light cyan", width=29, font=("Comic Sans MS", 20))
...
var = IntVar()
Radiobutton(root, text="HD", variable=var, font=("Helvetica", 15, "bold"), bg="black", fg='light cyan', value=1, width=10, borderwidth=3).place(x=160, y=290)
Radiobutton(root, text="SD", variable=var, font=("Helvetica", 15, "bold"), bg="black", fg='light cyan', value=2, width=10, borderwidth=3).place(x=360, y=290)
