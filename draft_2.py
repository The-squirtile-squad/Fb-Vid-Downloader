...
var = IntVar()
Radiobutton(root, text="HD", variable=var, font=("Helvetica", 15, "bold"), bg="royal blue", value=1, width=10, borderwidth=3).place(x=180, y=290)
Radiobutton(root, text="SD", variable=var, font=("Helvetica", 15, "bold"), bg="royal blue", value=2, width=10, borderwidth=3).place(x=380, y=290)
